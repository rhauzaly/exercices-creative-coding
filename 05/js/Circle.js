...
class Circle {
  constructor(x, y, rayon, context, svgPath) {
    this.x = x;
    this.y = y;
    this.origin = { x: x, y: y };
    this.target = { x: x, y: y };
    ...
    this.angle = 0;
    this.svg = new Image();
    this.svg.src = "image/R2.svg"; // Chemin vers le fichier SVG
    this.isSvg = false; // Attribut pour suivre si l'objet est un cercle ou un SVG
  }
